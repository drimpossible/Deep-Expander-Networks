...
import math
from layers.expandergraphlayer import ExpanderConv2dReverse, ExpanderConv2d, channelShuffle
...
class Net(nn.Module):
    def __init__(self, n_class=100, input_size=32, width_mult=1., gtype='full', hsp=1, lsp=1, lexp=1, hexp=1):
        super(Net, self).__init__()
        # setting of inverted residual blocks
        self.interverted_residual_setting = [
            # t, c, n, s
            [1, 16, 1, 1, "full", 1, 1 ,1],
            [6, 24, 2, 1, gtype, hsp, hsp, 1],
        ...
        self.features.append(nn.AvgPool2d(4))
